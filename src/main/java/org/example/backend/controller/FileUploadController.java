        ...
        try {
            ...
            if (resource.exists() && resource.isReadable()) {
                ...
                try {
                    ...
                    // Fallback to application/octet-stream on invalid MIME type
